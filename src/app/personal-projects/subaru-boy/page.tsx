...
// image imports
const sbBanner = '/cruel_santino_subaru_boy_wide.jpg';
const sb3DModel = '/cruel_santino_subaru_boy_3d_model.jpg';
    ...
    <div className="personal-project-container bg-black w-full h-auto">
      ...
      <div className="personal-project-sections w-full h-auto flex flex-col items-center justify-center relative">
          ...
          <article className="personal-project-design-goal-container h-auto w-full flex flex-col hd:flex-row p-5 hd:py-20 hd:px-5 selection:bg-orange-600 selection:text-zinc-200">
            <div className="personal-project-design-goal-description-container h-auto w-full hd:w-3/5 hd:max-h-[1500px] xl:pl-20">
              ...
              <motion.p
                ...
                transition={{ delay: 0.3, ease: 'anticipate', duration: 1 }}
              >
                I&#39;ve drawn Santi around 5 to 6 times; it&#39;ll be tough to
              ...
              <motion.p
                ...
                transition={{ delay: 0.3, ease: 'anticipate', duration: 1 }}
              >
                I&#39;m always making projects based on my personal interests,
                being a Subaru Boy just happens to be one of them.
              </motion.p>
            </div>
        ...
        <nav className="personal-project-navigate h-[468px] w-full bg-orange-600 selection:bg-black selection:text-zinc-200 p-5">
          ...
          >
            <Link href={'/personal-projects/animation-project'}>
              <li className="personal-project-navigate-previous h-full w-2/5 hd:w-1/4 flex flex-col items-start justify-center cursor-pointer">
            ...
            <Link href={'/personal-projects/music'}>
              <li className="personal-project-navigate-next h-full w-2/5 hd:w-1/4 flex flex-col items-end justify-center cursor-pointer">
