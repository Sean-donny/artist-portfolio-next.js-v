          ...
          <div className="ashley-obsession-content-images w-full h-full flex flex-col items-center justify-center md:flex-row mt-10">
            ...
            >
              <Image
                ...
                width={imageData.illustration1.width}
                height={imageData.illustration1.height}
                loading="eager"
            ...
            >
              <Image
                ...
                width={imageData.illustration2.width}
                height={imageData.illustration2.height}
                loading="eager"
            ...
            >
              <Image
                ...
                width={imageData.illustration3.width}
                height={imageData.illustration3.height}
                loading="eager"
